...
if(!isset($_SESSION['user_registr'])){
		...
		<div class="row">
			...
			<div class="col-12 p-0">
				<div class="container mt-4 text-center">
					<h3 class="my-3">Выбор доктора</h3>
								...
								<div class="row">
									...
									<div class="col-md-6 col-12">
										...
										if ($search_find) {
											...
											<a href=\"/registrar/choice_doctor.php\" class=\"text-secondary text-decoration-underline\">Открыть весь список</a>
											</div>";
										} else{}
										?>
									</div>
					...
					<div style="overflow-x: auto;white-space: nowrap;">
						<table class="table table-light table-bordered table-hover text-center"  border="1">
							...
							<tbody class="table-group-divider"> 
								...
								include '../assets/inc/function/search_doctor_record_regist.php';
	...
	while($row = mysqli_fetch_array($res_data)){?>
		<tr>
			...
			<td class="p-2"><a href="page/record_patients.php?doctor=<?php echo ''.$row['id'].'' ?>">Записать к врачу</a></td>
		</tr> 
	<?php    }
	?>
