...
echo '<div class="container-fluid">
    <div class="row justify-content-center">
        <div class="col-sm-6 col-11 my-5 p-3 border bg-white rounded">
            ...
            <a href="/" class="mt-3 w-100 btn btn-primary">Открыть мои записи в поликлинику</a>
            <a href="../choice_doctor.php" class="mt-3 w-100 btn btn-primary">Вернуться на запись к врачу</a>
        </div>
    </div>
</div>';
